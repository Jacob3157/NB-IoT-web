...
public class TokenUtil {
    ...
    public static void saveToken(TokenInfo token){
    	...
    	TokenInfoService tokenInfoService=(TokenInfoService) context.getBean("tokenInfoService");
    	tokenInfoService.addToken(token);
    }
     ...
     * @return
     */
    public static TicketInfo getTicket(String access_token) {
  ...
  //保存TicketInfo
    public static void saveTicket(TicketInfo ticket){
    	ApplicationContext context=APPContextUtil.getContext();
    	TicketInfoService ticketInfoService=(TicketInfoService) context.getBean("ticketInfoService");
    	ticketInfoService.addTicket(ticket);;
    }
