...
<body  style="background: #FFDAB9;">
  <div class="col-xs-12" style="background-color: #008800;text-align: center;display: inline;font-size: 2em"><span class="glyphicon glyphicon-user" style="vertical-align:middle;color:#FFF">NB-IoT信息</span></div> 
  <div class="container" style="background: #FFDAB9;">
    <div class="row idcard " style="background-color: #FFFFFF;border-radius: 5px;margin-top: 5%" >
      <div class="pic col-xs-4" style="margin-top: 8px">
        <img  src="/Wechat/images/welllid.jpg" class="img-thumbnail">
      </div>
      <div class="info-basic col-xs-8" style="background-color: #FFFFFF;">
        <div style="text-align: left;">
          <h4 class = "col-xs-4" style="display: inline;"><strong>位置:</strong></h4><h4 class="col-xs-7" style="display: inline;"><strong>${user.name!""}</strong></h4>
          <hr>
        </div>
        <div style="text-align: left;">
          <h4 class = "col-xs-4" style="display: inline;"><strong>坐标:</strong></h4><h4 class="col-xs-7" style="display: inline;"><strong>${user.studentID!""}</strong></h4>
          <hr>
        </div>
        <div style="text-align: letter-spacing: ;">
          <h4 class = "col-xs-4" style="display: inline;;"><strong>编号:</strong></h4><h4 class="col-xs-7" style="display: inline;"><strong>${user.telephone!""}</strong></h4>
          <hr>
        </div>
      </div>
    </div>
     <div class="info-washing col-xs-12 " style="margin-bottom: 0%; background-color: #FFDAB9;text-align:center;padding-top: 8%;">
        <div class="col-xs-3" style="text-align: left;">
            <div type="button" class="btn btn-danger btn-circle btn-lg" style="margin-top: 15%"> 
              <h5 style="text-align: center;"><strong>湿度</strong></h5>
              <h3><strong>${humidity!"0" }</strong></h3>
          </div>
        </div>
        <div class="col-xs-3" style="text-align: right; margin-top: 30%">
            <div type="button" class="btn btn-info btn-circle btn-lg" style="margin-top: 15%"> 
              <h5 style="text-align: center;"><strong>温度</strong></h5>
              <h3><strong>${temp!"0" }</strong></h3>
          </div>
        </div>
        <div class="col-xs-3" style="text-align: left;">
            <div type="button" class="btn btn-success btn-circle btn-lg" style="margin-top: 15%"> 
              <h5 style="text-align: center;"><strong>开启次数</strong></h5>
              <h3><strong>${openTimes!"0" }</strong></h3>
          </div>
        </div>
      </div>
  </div>
