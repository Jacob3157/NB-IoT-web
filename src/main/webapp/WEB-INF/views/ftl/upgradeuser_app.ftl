  ...
  <script type="text/javascript">
    function upload(){
        ...
        $(function() {
          ...
          var openid="${openid}" ;
          var orga=  document.getElementById("organization").value.toString();
          var name=document.getElementById("stu").value.toString();
          var url="/Wechat/update/user?studentID="+studentID+"&telephone="+telephone+"&openid="+openid+"&name="+name+"&organization="+orga;
      ...
      function validateName(){
          var name=document.getElementById("stu").value;
          if(name==''){
            document.getElementById("a").style.display = "";
            document.getElementById("nameNotice").style.display = "";
            document.getElementById("stu").focus();
            return null;
          }
      ...
      function stuSubmit(){
        ...
        if(validateName()!="success") return;
...
<body style="background-color: #E0FFFF">
    ...
    <div role="form" class="col-xs-offset-1 col-xs-10" style="margin-top: 8%;background-color: #FAFAD2 ;padding: 5%;border-radius: 15px">
      <div class="text-align center" style=display:none id="a">
        ...
        <span id="nameNotice" style=display:none>姓名不可为空!</span>
      </div>
      <div class="from-group"  >
        <label for="name">姓名</label><input type="text" id="stu" class="form-control" placeholder="请输入姓名" onblur="validateName()"/>
      </div>
     ...
     <select id ="organization" class="form-control">
      ...
      <option value="2">上海纽约大学</option>
      <option value="3">上海财经</option>
      <option value="4">华东师大</option>
      <option value="5">PIOT</option>
    </select>
      </div>
